    ...
    *,
    ...
    lines.extend(
        [
            ...
            "- A `verified` receipt proves fresh run evidence exists; it is not a code-quality verdict.",
            "- Codex must produce the merge/fix/blocked verdict for implementation work.",
